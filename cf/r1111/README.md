...
- We can easily check that if we have two numbers a and b s.t. (a-b)%m=0, then a%m = b%m. We can also use this to prove that in any array with m elements, there is a subarray whose sum is divisible by m.
